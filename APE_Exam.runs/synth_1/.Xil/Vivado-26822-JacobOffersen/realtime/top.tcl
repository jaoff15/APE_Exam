...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-26822-JacobOffersen/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-26822-JacobOffersen/realtime/top_synth.xdc
    rt::sdcChecksum
    set rt::top top
...
# MODE: 
    rt::set_parameter webTalkPath {/home/jacoboffersen/advanced_programmable_electronics/APE_Exam/APE_Exam.cache/wt}
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-26822-JacobOffersen/"
